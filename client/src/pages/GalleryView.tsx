...
export default function GalleryView() {
  ...
  const galleryItems: GalleryItem[] = [
    ...
    {
      id: "doc-5",
      src: "/images/groba.avif",
      alt: "Grób Agnieszki Gierczak",
      category: "places",
      titleKey: "gallery.item.doc-5.title",
      descriptionKey: "gallery.item.doc-5.desc",
    },
    {
      id: "doc-3",
      src: "/images/grobjrh.avif",
      alt: "Wspólny grób Józefa, Rozalii i Heleny Ofiarów",
      category: "places",
