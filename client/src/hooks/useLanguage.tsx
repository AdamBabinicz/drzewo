...
const translations = {
  pl: {
    ...
    "gallery.item.place-3.desc":
      "Miejsce spoczynku przodków ze strony babci Heleny, prababci Ewy i pradziadka Karola",
  ...
  en: {
    ...
    "gallery.item.place-3.desc":
      "Resting place of ancestors from the side of grandmother Helena, great-grandmother Ewa and great-grandfather Karol",
