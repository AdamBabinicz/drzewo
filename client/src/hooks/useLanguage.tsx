...
const translations = {
  pl: {
    ...
    "gallery.item.portrait-2.desc": "Marianna Ofiara - moja mama",
    ...
    "gallery.item.place-5.title":
      "Droga do domu babci Heleny, lata 70-te XX w.",
    "gallery.item.place-5.desc": "Na zdjęciu ja z moim tatą Józefem",
    ...
    "person.witnesses": "Świadkowie",
    "person.marriedOn": "ślub",
    "person.marriedTo": "Małżeństwo z",
  ...
  en: {
    ...
    "home.seo_title":
      "Gierczak and Ofiara Families – Genealogical Tree and Family Histories",
    "home.description":
    ...
    "gallery.item.portrait-2.desc": "Marianna Ofiara - my mother",
    "gallery.item.portrait-3.title": "Ancestor's Portrait",
    "gallery.item.portrait-3.desc":
      "One of the oldest members of the serfdom-era family, generated by AI based on 3 descendants",
    ...
    "gallery.item.doc-5.title": "The grave of Agnieszka Gierczak",
    "gallery.item.doc-5.desc": "Parish cemetery in Zakrzów (Zakrzew)",
    ...
    "gallery.item.place-5.title":
      "The road to grandmother Helena's house, 1970s",
    "gallery.item.place-5.desc": "In the photo: me with my father Józef",
    ...
    "person.witnesses": "Witnesses",
    "person.marriedOn": "m.",
    "person.marriedTo": "Married to",
